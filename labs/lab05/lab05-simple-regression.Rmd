...
Get a histogram and boxplot, as well as summary statistics for the variables 
`TV` and `Sales`. Does it make sense to fit a regression line between `TV` and `Sales`?
...
with the results from the function `confint()`.
